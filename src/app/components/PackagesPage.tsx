  ...
  const packages = [
    { 
      ...
      includes: [
        ...
        'Full access to all tennis matches',
        'VIP seating for all performances',
        'Island activities and water sports',
        'Spa access',
    ...
    { 
      ...
      includes: [
        'Nearby island resort accommodation',
        'Daily boat transfers to Necker Island',
        'Premium courtside tennis viewing',
        'VIP seating for performances',
        'Artist meet & greet access',
        'All meals during events',
    ...
    { 
      ...
      includes: [
        ...
        'All meals and premium beverages',
        'Exclusive artist rehearsal access',
        'Private tennis clinic with pros',
        'Extended 6-night island stay',
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="text-center mt-12">
            ...
            <p className="font-body text-stone-400 text-xs">
              Prices are per person. Accommodation is based on double occupancy. Single occupancy available at additional cost.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-gradient-to-br from-emerald-900 to-teal-800 text-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-12 text-center">
          <h2 className="font-display text-4xl md:text-5xl mb-6">
            Ready to reserve your <span className="italic">spot</span>?
          </h2>
